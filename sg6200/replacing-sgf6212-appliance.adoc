...
---
= Substitua o dispositivo de storage SGF6212
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.. link:reinstalling-sg6200-into-cabinet-or-rack.html["Remova o aparelho com falha do gabinete ou rack"].
...
+
image::../media/sgf6212_front_with_ssds.png[Localizações das ventoinhas]
...
CAUTION: Se desejar manter os dados nos discos, certifique-se de inserir os SSDs nos mesmos slots que ocupavam no dispositivo com falha. Caso contrário, o Appliance Installer exibirá uma mensagem de aviso e você precisará inserir os discos nos slots corretos e reinicializar o dispositivo antes que ele possa se reconectar à grid.

.. link:reinstalling-sg6200-into-cabinet-or-rack.html["Instale o aparelho de substituição no gabinete ou rack"].
...
* link:../installconfig/troubleshooting-hardware-installation-sg6200.html#view-boot-codes["Veja os códigos de inicialização do aparelho"]
