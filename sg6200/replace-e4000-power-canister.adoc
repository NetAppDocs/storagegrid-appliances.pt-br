...
---
= Substitua o cartucho de energia no compartimento do controlador de armazenamento ou compartimento de expansão (SG6260)
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
É possível substituir um compartimento de alimentação em um shelf de controlador de storage SG6260 ou compartimento de expansão (DE460C).
