...
---
= Substitua o compartimento do ventilador na shelf do controlador de storage ou compartimento de expansão (SG6260)
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
É possível substituir o compartimento do ventilador em um SG6260.
