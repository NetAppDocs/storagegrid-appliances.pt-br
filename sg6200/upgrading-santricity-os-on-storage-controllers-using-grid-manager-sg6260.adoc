...
summary: 'Para controladores de armazenamento que atualmente usam SANtricity OS 08.42.20.00 (11.42) ou mais recente, você pode usar o Grid Manager ou o modo de manutenção para aplicar uma atualização.' 
---
= Atualize o sistema operacional SANtricity em controladores de armazenamento SG6200 usando o Grid Manager
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Você pode usar o Grid Manager ou o modo de manutenção para aplicar um upgrade.
...
** Selecione um ou mais botões *Aprovar* para adicionar um ou mais nós à fila de atualização do SANtricity OS. O botão *Aprovar* fica desabilitado se o Status não for Nominal.
+
...
Não é necessária qualquer outra ação.
 ...
 a| 
A atualização do sistema operacional SANtricity não se aplica a este nó.
 a| 
O nó não tem um controlador de storage que pode ser gerenciado pelo sistema StorageGRID. Conclua o processo de atualização sem atualizar o nó exibindo esta mensagem.
 ...
 a| 
O arquivo do sistema operacional SANtricity não é compatível com este nó.
 a| 
...
* link:upgrading-santricity-os-on-storage-controllers-using-maintenance-mode-sg6260.html["Atualize o sistema operacional SANtricity em controladores SG6200 usando o modo de manutenção"]
