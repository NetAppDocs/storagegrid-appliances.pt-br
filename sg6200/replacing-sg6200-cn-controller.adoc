...
summary: Você poderá precisar substituir o controlador SG6200-CN se ele não estiver funcionando de forma ideal ou se tiver apresentado defeito. 
---
= Substituir SG6200-CN controller
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Você poderá precisar substituir o controlador SG6200-CN se ele não estiver funcionando de forma ideal ou se tiver apresentado defeito.

.Sobre esta tarefa
O nó de storage do dispositivo ficará inacessível quando você substituir o controlador SG6200-CN. Se o controlador SG6200-CN estiver funcionando suficientemente, você pode realizar um desligamento controlado no início deste procedimento.
...
+
link:locating-sg6200-in-data-center.html["Localize o controlador no data center"]
...
. Se o controlador SG6200-CN estiver funcionando de forma suficiente para permitir um desligamento controlado, link:power-sg6200-off-on.html["desligue o controlador SG6200-CN"].
...
. Remova e substitua o controlador SG6200-CN:
+
