...
summary: Você pode desligar o appliance SG6200 e ligá-lo novamente para realizar a manutenção. 
---
= Desligue e ligue o appliance SGF6212 ou o controlador SG6200-CN
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Você pode desligar o dispositivo SGF6212 ou o controlador SG6200-CN e ligá-los novamente para realizar a manutenção.



== Desligue o dispositivo SGF6212 ou o controlador SG6200-CN
...
== Ligue o SGF6212 ou SG6200-CN e verifique o funcionamento

Ligue o controlador após concluir a manutenção.

.Antes de começar
* Você já link:reinstalling-sg6200-into-cabinet-or-rack.html["instalado o controlador em um gabinete ou rack"] conectou os cabos de dados e de energia.
* Você tem link:locating-sg6200-in-data-center.html["localizado fisicamente o controlador no data center"].
