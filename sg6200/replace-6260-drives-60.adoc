...
---
= Substitua a unidade na prateleira do controlador de storage ou compartimento de expansão (SG6260)
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Você pode substituir uma unidade em um gabinete de controlador de storage SG6260 ou compartimento de expansão (DE460C).
