...
summary: 'Pode ser necessário substituir a placa de interface de rede (NIC) no SGF6212 se ela não estiver funcionando corretamente ou se tiver apresentado defeito.' 
---
= Substitua a placa de rede interna no SGF6212 ou SG6200-CN
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Pode ser necessário substituir a placa de interface de rede (NIC) interna do SGF6212 ou SG6200-CN se ela não estiver funcionando corretamente ou se tiver apresentado defeito.
...
* Você está link:locating-sg6200-in-data-center.html["localizou fisicamente o dispositivo SGF6212 ou o controlador SG6200-CN"] onde está substituindo a placa de rede no data center.
+
...
+
image:../media/drw_s2025_io_numbers_ieops-2554.svg["Localização das placas de rede no dispositivo"]
...
1
 a| 
NIC 1 no conjunto riser de um slot
 a| 
Portas de rede Ethernet 10/25-GbE para as redes Grid e de clientes
...
2
 a| 
NIC 2 no conjunto riser de um slot
 a| 
Portas de rede Ethernet 1/10-GbE para Admin Network
...
3
 a| 
NIC 3 no conjunto riser de um slot
 a| 
Portas de rede Ethernet 10/25-GbE para as redes Grid e de clientes
...
NOTE: Alguns appliances suportam portas de rede de alta velocidade e podem ter NICs de alta velocidade instaladas.
