...
---
= Atualize o firmware da unidade SG6200 usando SANtricity System Manager pelo método offline (SG6260)
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
NOTE: Este procedimento *não* se aplica aos SSDs NVMe do SG6200-CN, que são atualizados durante as atualizações de software do StorageGRID. Somente as unidades do E4000 podem ser atualizadas usando este procedimento.
...
** Utilize o Gerenciador de Grade e selecione *Nós* > *_Nó de Armazenamento_* > *SANtricity System Manager*
