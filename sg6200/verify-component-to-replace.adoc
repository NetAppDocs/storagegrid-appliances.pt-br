...
---
= Verifique o componente a ser substituído no SGF6212 ou SG6200-CN
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
link:turning-sg6200-identify-led-on-and-off.html["Ligue o LED de identificação do aparelho"]
