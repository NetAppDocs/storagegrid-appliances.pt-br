...
---
= Procedimentos comuns de manutenção para StorageGRID appliances
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* link:../sg6200/index.html["Manutenção do dispositivo de storage SG6200"]
...
* link:../sg120-1200/index.html["Manutenção dos appliances SG120 e SG1200"]
