...
summary: 'Se você ativou a criptografia de nó para o dispositivo durante a instalação, poderá monitorar o status de criptografia de nó de cada nó do dispositivo, incluindo os detalhes do estado de criptografia de nó e do servidor de gerenciamento de chaves (KMS).' 
---
= Monitorar a criptografia de nó para um dispositivo de StorageGRID em modo de manutenção
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
