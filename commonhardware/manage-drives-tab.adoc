...
---
= Use a guia Gerenciar unidades para os dispositivos StorageGRID SG110, SG120, SG1100, SG1200, SG6100 e SG6200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
. No Gerenciador de Grade, selecione *Nós* > *_centro de dados_*.
