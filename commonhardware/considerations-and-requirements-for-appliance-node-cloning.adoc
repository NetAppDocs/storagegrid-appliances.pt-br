...
---
= Requisitos para clonagem de nó do dispositivo StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Se você estiver habilitando o DHCP em alguma porta do nó de destino que tenha sido configurada como estática no nó de origem, certifique-se de que não haja concessões DHCP permanentes para nenhum dos endereços MAC do nó de origem. Se não fizer isso, poderá ocorrer um conflito de endereço IP ao final do processo de clonagem.
...
+
O nó de origem e o dispositivo de destino podem ter configurações de criptografia de nó diferentes, com as seguintes exceções. A clonagem de nó não é suportada de origens com nós não criptografados para destinos com nós criptografados nos seguintes dispositivos:
...
** Um dispositivo de nó SG1200 sem criptografia de nó para um dispositivo SG1200 com criptografia de nó
** Um dispositivo de nó SG110 sem criptografia de nó para um dispositivo SG110 com criptografia de nó
** Um dispositivo de nó SG120 sem criptografia de nó para um dispositivo SG120 com criptografia de nó
...
* Determine se o modo RAID no dispositivo de destino deve ser alterado em relação à configuração padrão, para que você possa especificar essa informação durante a instalação inicial do dispositivo de destino antes da clonagem. Você pode visualizar informações sobre o modo RAID atual do nó do dispositivo de origem na página *Nodes* no Grid Manager. Selecione a guia *Hardware* do dispositivo.
+
