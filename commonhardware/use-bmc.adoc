...
---
= Controlador de gerenciamento de placa-mãe para StorageGRID appliances
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* https://docs.netapp.com/us-en/storagegrid/harden/hardening-guidelines-for-storagegrid-nodes.html#change-appliance-bmc-password["Alterar a senha do BMC do appliance no Grid Manager"^]
* https://docs.netapp.com/us-en/storagegrid/maintain/changing-nodes-network-configuration.html#change-appliance-node-bmc-lan-ip-settings["Configurar as configurações de endereço IP da LAN BMC"^]
