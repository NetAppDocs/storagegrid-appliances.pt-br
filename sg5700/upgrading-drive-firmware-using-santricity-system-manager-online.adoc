...
---
= Atualize o firmware da unidade SG5700 usando o método online do SANtricity System Manager
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Você deve usar o link:upgrading-drive-firmware-using-santricity-system-manager-offline.html["método offline"] ao atualizar unidades SSD.
