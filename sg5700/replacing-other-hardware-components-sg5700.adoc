...
Condução
 a| 
link:https://docs.netapp.com/us-en/e-series/maintenance-e2800/drives-12-24-supertask-task.html["Substituição de uma unidade nas gavetas de E2800 12 ou 24 unidades"^]
...
Depósito da ventoinha de alimentação
 a| 
link:https://docs.netapp.com/us-en/e-series/maintenance-e2800/canisters-fan-supertask-task.html["Substituição de um recipiente do ventilador elétrico em E2800 prateleiras"^]
...
Condução
 a| 
link:https://docs.netapp.com/us-en/e-series/maintenance-e2800/drives-12-24-supertask-task.html["Substituição de uma unidade em E2860 gavetas"^]
...
Depósito de alimentação
 a| 
link:https://docs.netapp.com/us-en/e-series/maintenance-e2800/canisters-60-replace-power-task.html["Substituição de um recipiente de alimentação em E2860 prateleiras"^]
...
Recipiente da ventoinha
 a| 
link:https://docs.netapp.com/us-en/e-series/maintenance-e2800/canisters-fan-supertask-task.html["Substituição de um recipiente do ventilador em E2860 prateleiras"^]
...
Gaveta da unidade
 a| 
link:https://docs.netapp.com/us-en/e-series/maintenance-e2800/drives-60-supertask-task.html["Substituição de uma gaveta de unidades em E2860 gavetas"^]
