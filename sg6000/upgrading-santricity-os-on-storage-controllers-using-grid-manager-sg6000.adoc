...
summary: 'Para controladores de storage que atualmente usam o SANtricity os 08.42.20.00 (11,42) ou mais recente, você deve usar o Gerenciador de Grade para aplicar uma atualização.' 
---
= Atualize o SANtricity OS nos controladores de armazenamento SG6000 com o Grid Manager
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
