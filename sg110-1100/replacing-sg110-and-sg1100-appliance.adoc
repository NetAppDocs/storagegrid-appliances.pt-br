...
---
= Substitua o appliance SG110 ou SG1100
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
CAUTION: Se você quiser manter os dados nas unidades, insira as unidades SSD nos mesmos slots de unidade que elas ocupavam no dispositivo com falha.  Caso contrário, o instalador do aparelho exibirá um aviso e você terá que colocar as unidades nos slots corretos e reinicializar o aparelho antes que ele possa se conectar novamente à rede.
