...
[role="lead"]
Acesse  https://docs.netapp.com/us-en/storagegrid/index.html["Documentação do StorageGRID 12.1"^] para aprender como configurar e usar um sistema StorageGRID 12.1.
...
* https://docs.netapp.com/us-en/storagegrid-120/index.html["Documentação do StorageGRID 12.0"^]
