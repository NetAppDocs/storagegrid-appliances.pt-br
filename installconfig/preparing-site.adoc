...
---
= Prepare o local para a instalação do StorageGRID appliance
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
NOTE: As fontes de alimentação dos appliances StorageGRID são classificadas para potências significativamente maiores do que as utilizadas pelo hardware dos appliances StorageGRID, mesmo durante períodos de consumo máximo de energia. NetApp recomenda usar o  https://hwu.netapp.com["NetApp Hardware Universe"^] para determinar se um layout de rack proposto que inclua appliances StorageGRID é compatível com o orçamento de energia do seu rack.
...
55,98 lb. (25,39 kg)
 ...
 a| 
Controlador de computação SG6200-CN (SG6260)
 a| 
1,70 pol. (4,32 cm)
 a| 
18,98 pol. (48,21 cm)
...
44,0 lb. (19,70 kg)
 ...
 a| 
Prateleira do controlador E4060 (SG6260)
 a| 
6,87 pol.
...
(101,42 kg)
 ...
 a| 
Compartimento de expansão (SG6260) - Opcional
 a| 
6,87 pol.
...
CAUTION: Ao instalar a prateleira do controlador E2860 ou E4000 ou as prateleiras de expansão opcionais, instale o hardware de baixo para cima no rack ou gabinete para evitar que o equipamento tombe. Para garantir que o equipamento mais pesado fique na parte inferior do gabinete ou rack, instale o SG6000-CN, SG6100-CN ou SG6200-CN controller acima da prateleira do controlador E2860 ou E4000 e das prateleiras de expansão.

+

NOTE: Antes de iniciar a instalação, verifique se os cabos fornecidos com o SG6000, SG6100 ou SG6200, ou os cabos que você fornecer, têm comprimento suficiente para o layout planejado.
