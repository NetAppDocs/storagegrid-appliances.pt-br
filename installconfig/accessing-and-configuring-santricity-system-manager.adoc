...
---
= Configure SANtricity para os dispositivos de StorageGRID SG6260, SG6160, SG6000, SG5700 e SG5800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Os seguintes dispositivos StorageGRID podem acessar SANtricity System Manager:
...
* Chaves de segurança da unidade, necessárias para desbloquear unidades protegidas
+

NOTE: Você precisa configurar e ter acesso ao SANtricity System Manager se o recurso de Drive Security estiver habilitado para o seu dispositivo.
...
** Utilize o Gerenciador de Grade e selecione *Nós* > `*_appliance Storage Node_*` > *SANtricity System Manager*
...
.SG6260
--
O dispositivo de storage SG6260 pode ser equipado com unidades compatíveis com FIPS tanto no controlador de computação SG6200-CN quanto no gabinete do controlador E4000. A criptografia das unidades é configurada separadamente para as unidades do SG6200-CN e do E4000.

.. link:optional-enabling-node-encryption.html#drive-encryption["Ative a encriptação da unidade"] para SSDs SED instalados no nó de computação SG6200-CN.
.. Crie uma chave de segurança (uma cadeia de carateres compartilhada pelo controlador e unidades para acesso de leitura/gravação).
+
*** Você pode https://docs.netapp.com/us-en/e-series-santricity/sm-settings/create-internal-security-key.html["crie uma chave interna"^] usar a partir da memória persistente do controlador ou uma chave externa fornecida por um servidor de gerenciamento de chaves.
*** Para usar uma chave externa fornecida por um servidor de gerenciamento de chaves, você deve primeiro https://docs.netapp.com/us-en/e-series-santricity/sm-settings/overview-drive-security.html["estabeleça a autenticação com um servidor de gerenciamento de chaves"^] no Gerenciador de sistemas do SANtricity.
...
NOTE: Siga este procedimento somente se você não tiver acesso ao SANtricity System Manager a partir do StorageGRID Appliance Installer (*Advanced* > *SANtricity System Manager*) ou do Grid Manager (*Nodes* > *SANtricity System Manager*).
