...
---
= Conecte um dispositivo de StorageGRID ou controlador por cabo
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
** Um a quatro cabos Twinax para ligar as quatro portas de rede.
** Para o SG120, de um a quatro transceptores SFP+ ou SFP28 se você planeja usar cabos ópticos para as portas.
** Para o SG1200, de um a quatro transceptores QSFP+, QSFP28 ou QSFP56 (somente para NIC 200GbE) caso você planeje usar cabos ópticos para as portas.
...
Conexões de porta SG120:

image::../media/sg120_connections.png[Conectores traseiros SG120]

Conexões de porta SG1200:

image::../media/sg1200_connections.png[Conexões de porta SG1200]
...
* 10/25/40/100-GbE com 100G NIC
* 10/25/50/100/200-GbE (somente NIC de 200-GbE)

 a| 
Conecte-se à Rede Grid e à Rede Cliente para StorageGRID. Consulte link:gathering-installation-information-sg120-and-sg1200.html#port-bond-modes["Modos de ligação de portas (SG120 e SG1200)"]
...
[cols="2a,2a"]
|===
| Velocidade de link SG120 (GbE) | Equipamento necessário 
...
[cols="2a,2a"]
|===
| Velocidade de link SG1200 (GbE) | Equipamento necessário 
...
NOTE: O estado do link físico para a porta 1 não está disponível no software e deve ser verificado neste momento usando o LED de status no controlador SG5800.
...
.Antes de começar
* Apenas para o modelo SG6200: Você possui o cabo breakout de 100GbE para 4x25GbE fornecido com o dispositivo para conectar os dois controladores de armazenamento ao controlador SG6200-CN.
* Você tem cabos Ethernet RJ-45:
+
** Um cabo RJ-45 para conetar a porta de gerenciamento.
** Apenas para o SG6200: até quatro cabos Ethernet RJ-45 adicionais para as portas opcionais que você planeja usar, incluindo a segunda porta Admin e a porta BMC no SG6200-CN, e as portas de manutenção em cada um dos dois controladores E4000.


* Tem uma das seguintes opções para as portas de rede. Estes itens não são fornecidos com o aparelho.
+
** Um a quatro cabos Twinax para ligar as quatro portas de rede.
** De um a oito transceptores SFP+, SFP28, QSFP+, QSFP28 ou QSFP56, caso você planeje usar cabos ópticos para as portas.
...
.Sobre esta tarefa
As figuras a seguir mostram as portas na parte traseira do SGF6212 e os três controladores no dispositivo SG6200. O dispositivo SG6200 inclui um controlador de computação SG6200-CN na parte superior e dois controladores de armazenamento E4000 na parte inferior.

Conexões SGF6212:

image::../media/sgf6212_connections.png[Conectores traseiros SGF6212]

Conexões SG6260:

image::../media/sg6200_e4000_connections.png[Conexões SG6200-CN para E4000]
...
2
 a| 
Quatro portas de rede no controlador SG6200-CN
 a| 
* Quatro portas de rede 10/25/40/100-GbE ou 200-GbE com opcional 200G NIC SKU

 a| 
Conecte-se à Rede Grid e à Rede Cliente para StorageGRID. Consulte link:gathering-installation-information-sg6200.html#port-bond-modes["Modos de ligação de portas (SG6200)"]
...
Cinco portas de conexão totais
 a| 
* Uma porta 100GbE no SG6200-CN
* Duas portas 10/25GbE em cada uma das controladoras de storage

 a| 
Conecte cada controlador de armazenamento ao controlador SG6200-CN.
...
. Conecte as duas portas de interconexão em cada controlador de armazenamento à porta 100GbE no controlador SG6200-CN, usando um cabo 100-GbE QSFP28 para 4x25-GbE SFP28.
. Ligue as portas de rede do aparelho aos comutadores de rede adequados, utilizando cabos Twinax ou cabos óticos e transcetores.
+
[cols="2a,2a"]
|===
...
. Se pretender utilizar a rede de administração para StorageGRID, ligue a porta de rede de administração do dispositivo à rede de administração, utilizando um cabo Ethernet.
. Se o seu dispositivo de storage incluir um compartimento de expansão, consulte as link:../sg6200/adding-expansion-shelf-to-deployed-sg6260.html["Instruções para adicionar um compartimento de expansão a um SG6200 já instalado"] informações de cabeamento.
