...
---
= Alterar o modo RAID para um SG5760, SG5860, SG6000, SG6160 ou SG6260
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Você pode alterar o modo RAID nos seguintes dispositivos:
...
** O DDP oferece proteção contra perda de gavetas nos appliances SG5760, SG5860, SG6160 e SG6260.
+
