...
---
= Reúna informações de rede para o SG120 e o SG1200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Antes de instalar um dispositivo de serviços SG120 ou SG1200, confirme se o seu sistema StorageGRID está utilizando a versão necessária do software StorageGRID.
...
image::../media/sg120_rj_45_ports.png[Portas SG120 RJ-45]

Portas RJ-45 do SG1200:

image::../media/sg1200_rj_45_ports.png[Portas SG1200 RJ-45]
...
Velocidade da ligação
 a| 
Para o SG120, escolha uma das seguintes opções:
...
Para o SG1200, escolha uma das seguintes opções:
...
*Nota:* Para o SG1200, as velocidades de 10 e 25 GbE exigem o uso de adaptadores QSA.
...
Porta de gerenciamento BMC SG120:

image::../media/sg120_bmc_management_port.png[Porta de gerenciamento SG120]

Porta de gerenciamento BMC SG1200:
...
Quando link:configuring-network-links.html["configurando links de rede"] para os dispositivos SG120 e SG1200, você pode usar a agregação de portas para as portas que se conectam à Grid Network e à Client Network opcional, e as portas de gerenciamento 1-GbE1/10-GbE que se conectam à Admin Network opcional. A agregação de portas ajuda a proteger seus dados, fornecendo caminhos redundantes entre as redes StorageGRID e o dispositivo.
...
O modo de agregação de portas fixas é a configuração padrão para as portas de rede. As figuras mostram como as portas de rede no SG1200 ou SG120 são agregadas no modo de agregação de portas fixas.
...
image::../media/sg1200_aggregate_ports.png[Modo de ligação de porta agregada SG1200]
...
image::../media/sg120_bonded_management_ports.png[Portas de gerenciamento de rede agregadas SG120]

SG1200:

image::../media/sg1200_bonded_management_ports.png[Portas de gerenciamento de rede agregadas SG1200]
