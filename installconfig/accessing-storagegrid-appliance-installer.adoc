...
summary: 'Você deve acessar o StorageGRID Appliance Installer para verificar a versão do instalador e configurar as conexões entre o appliance e as três redes StorageGRID: a Grid Network, a Admin Network (opcional) e a Client Network (opcional).' 
---
= Acesse o instalador do dispositivo StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.SG120
--
image::../media/sg120_admin_network_port.png[Porta de rede administrativa no SG120]
...
.SG1200
--
image::../media/sg1200_admin_network_port.png[Porta de rede administrativa no SG1200]
...
.SG6200-CN
--
image::../media/sg6200_cn_admin_network_port.png[Porta de rede administrativa no controlador SG6200-CN]
...
.SGF6212
--
image::../media/sgf6212_admin_network_port.png[Porta de rede administrativa no SGF6212]
...
image::../media/sg120_link_local_port.png[Conexão link-local SG120]
...
image::../media/sg1200_link_local_port.png[Conexão link-local SG1200]
...
.SG6200-CN
--
Conecte um laptop de serviço diretamente à porta RJ-45 mais à direita no controlador SG6200-CN, usando um cabo Ethernet.

image::../media/sg6200_cn_link_local_port.png[Localização da porta de gerenciamento para SG6200-CN]
...
image::../media/sgf6212_link_local_port.png[Conexão Link-Local SGF6212]
