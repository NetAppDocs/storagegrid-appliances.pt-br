...
summary: 'O appliance StorageGRID SG5800 é uma plataforma integrada de armazenamento e computação que opera como um Nó de Armazenamento em uma grade StorageGRID. O appliance pode ser usado em um ambiente de grade híbrido que combina Nós de Armazenamento appliance e Nós de Armazenamento virtuais (baseados em software).' 
---
