...
summary: Você pode acessar a interface BMC usando o endereço IP DHCP ou estático da porta de gerenciamento do BMC em alguns modelos de appliance. 
---
= Acesse a interface BMC em um dispositivo StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
