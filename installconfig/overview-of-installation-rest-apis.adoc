...
summary: StorageGRID fornece duas APIs REST para realizar tarefas de instalação, a StorageGRID Installation API e a StorageGRID Appliance Installer API. 
---
= APIs REST de instalação do StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
