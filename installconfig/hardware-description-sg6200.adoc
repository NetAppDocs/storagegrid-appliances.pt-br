...
+
--
* Um processador AMD de 3,55 GHz fornecendo 32 núcleos (64 threads)
* 256 GB DE RAM
* Unidade de inicialização interna de 256 GB (inclui o software StorageGRID)
...
4
 a| 
Controlador de armazenamento E-Series E4000 (1 de 2) e conectores
