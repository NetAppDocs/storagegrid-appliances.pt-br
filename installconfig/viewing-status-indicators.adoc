...
---
= Visualize os indicadores de status e códigos nos appliances StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* <<appliance_indicators_sg120_sg1200,Indicadores e botões do aparelho>>
* <<general_boot_codes_sg120_sg1200,Códigos gerais de arranque>>
* <<ssd_indicators_sg120_sg1200,Indicadores SSD>>


Utilize essas informações para ajudar link:troubleshooting-hardware-installation-sg120-and-sg1200.html["Solução de problemas de instalação de hardware SG120 e SG1200"].

[[appliance_indicators_sg120_sg1200]]
Indicadores e botões do aparelho::
+
--
A figura a seguir mostra os indicadores e botões na parte frontal dos appliances SG120 e SG1200.

image::../media/sg120_sg1200_front_indicators.png[Indicadores dianteiros - SG120 e SG1200]
...
PFR
 a| 
Esta luz não é utilizada pelos aparelhos SG120 e SG1200 e permanece desligada.

|===
--


A figura a seguir mostra a localização da fonte de alimentação e dos LEDs de identificação na parte traseira do SG120 e do SG1200. LEDs adicionais de status e atividade estão localizados nas portas do appliance. Esses LEDs podem variar de acordo com o modelo do appliance.
...
+
--
A figura a seguir mostra os indicadores SSD nos appliances SG120 e SG1200.
...
* <<appliance_indicators_SG6200,Indicadores e botões do aparelho>>
* <<general_boot_codes_SG6200,Códigos gerais de arranque>>
* <<ssd_indicators_SG6200,Indicadores SSD>>


Utilize essas informações para ajudar link:troubleshooting-hardware-installation-sg6200.html["Solução de problemas de instalação de hardware SG6200"].

[[appliance_indicators_SG6200]]
Indicadores e botões do aparelho::
+
--
A figura a seguir mostra os indicadores e botões na parte frontal dos appliances SG6200.

image::../media/s25_front_indicators.png[Indicadores dianteiros - SG6200]
...
PFR
 a| 
Esta luz não é utilizada pelos appliances SG6200 e permanece desligada.

|===
--


A figura a seguir mostra a localização da fonte de alimentação e dos LEDs de identificação na parte traseira do SGF6212 e do SG6200-CN. LEDs adicionais de status e atividade estão localizados nas portas do appliance. Esses LEDs podem variar de acordo com o modelo do appliance.

image::../media/s25_rear_leds.png[LEDs traseiros SGF6212 e SG6200-CN]
...
+
--
A figura a seguir mostra os indicadores de SSD no appliance SGF6212 ou SG6260.
...
*Nota:* Se um novo SSD em funcionamento for inserido em um nó StorageGRID SGF6212 ou SG6260 em funcionamento, os LEDs no SSD devem piscar inicialmente, mas parar de piscar assim que o sistema determinar que a unidade tem capacidade suficiente e está funcional.
