...
Além disso, ao ativar o modo FIPS após ativar a criptografia do nó, o módulo NetApp StorageGRID Kernel Crypto API 6.1.129-1-ntap1-amd64 é usado para criptografia de dados em repouso. Consulte  https://docs.netapp.com/us-en/storagegrid/admin/manage-tls-ssh-policy.html#select-a-security-policy["Selecione uma política de segurança"^] para mais informações.
