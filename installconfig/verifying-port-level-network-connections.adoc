...
Além disso, você pode testar a conetividade nas redes Admin e Client e nas portas UDP, como as usadas para servidores NFS ou DNS externos. Para obter uma lista dessas portas, consulte o https://docs.netapp.com/us-en/storagegrid-118/network/network-port-reference.html["referência da porta de rede"^].
