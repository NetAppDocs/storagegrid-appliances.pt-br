...
---
= Solução de problemas de instalação de hardware para um SG6200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
== [[view-boot-codes]]Exibir códigos de inicialização (somente SGF6212 e SG6260)
...
.. Confirme se os quatro cabos de interconexão entre o controlador SG6200-CN e os dois controladores de armazenamento estão firmemente conectados.
...
== [[view-error-codes]]Exibir códigos de erro (somente SGF6212 e SG6260)
...
=== Os compartimentos de expansão não aparecem no Appliance Installer (SG6260)
...
. Verifique se as gavetas de expansão estão ligadas. Consulte link:connecting-power-cords-and-applying-power.html["Conecte os cabos de alimentação e ligue a energia (SG6200)"].
. Se você precisar de ajuda para resolver um problema, entre em Contato com o suporte técnico.
