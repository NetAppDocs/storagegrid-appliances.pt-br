...
---
= Instale os compartimentos de 60 discos para um SG6260
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
CAUTION: Ao instalar a prateleira do controlador E4000 ou as prateleiras de expansão opcionais, instale o hardware de baixo para cima no rack ou gabinete para evitar que o equipamento tombe. Para garantir que o equipamento mais pesado fique na parte inferior do gabinete ou rack, instale o controlador SG6200-CN acima da prateleira do controlador E4000 e das prateleiras de expansão.
...
. Siga as instruções para instalar o SG6200-CN em um gabinete ou rack.
