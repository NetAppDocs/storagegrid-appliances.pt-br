...
* *Rede de gerenciamento para SANtricity* (opcional para appliances de armazenamento, não necessária para SGF6112 e SGF6212): Esta rede fornece acesso ao SANtricity System Manager, permitindo monitorar e gerenciar os componentes de hardware no appliance e no compartimento do controlador de armazenamento. Esta rede de gerenciamento pode ser a mesma que a rede de administração do StorageGRID ou pode ser uma rede de gerenciamento independente.
* *Rede de gerenciamento BMC* (opcional para os appliances SG6000, SG6100, SG6200 e de serviços): Esta rede fornece acesso ao controlador de gerenciamento da placa-mãe nos appliances SG6000, SG6100, SG6200 e de serviços, permitindo monitorar e gerenciar os componentes de hardware do appliance. Esta rede de gerenciamento pode ser a mesma que a Admin Network do StorageGRID ou pode ser uma rede de gerenciamento independente.
+
