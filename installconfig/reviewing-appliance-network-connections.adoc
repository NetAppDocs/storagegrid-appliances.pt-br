...
[role="lead"]
Antes de instalar o dispositivo StorageGRID, você deve entender quais redes podem ser conetadas ao dispositivo e como as portas em cada controlador são usadas. Os requisitos da rede StorageGRID são explicados na íntegra no https://docs.netapp.com/us-en/storagegrid-118/network/index.html["Diretrizes de rede"^].
...
NOTE: Para obter informações detalhadas sobre redes StorageGRID, consulte https://docs.netapp.com/us-en/storagegrid-118/network/storagegrid-network-types.html["Tipos de rede StorageGRID"^].
