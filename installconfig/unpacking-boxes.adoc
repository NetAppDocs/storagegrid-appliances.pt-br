...
---
= Desembale as caixas dos dispositivos StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
--
image::../media/sg120_front_view.png[Acionamentos dianteiros para appliances SG120 e SG1200]
...
* *Hardware SG6260*
+
Controlador SG6200-CN::
+
--
image::../media/s25_front_with_ssds.png[Controlador SG6200-CN]

--
Compartimento de controladora E4000U sem unidades instaladas::
+
--
image::../media/de460c_table_size.gif[Controlador E4000 4U]

--
Dois painéis frontais (não mostrados)::
+
--
image::../media/rail_kit.gif[Kit de calha]
...
+
--
image::../media/sg5760_drive.gif[Unidades NL-SAS de 60 TB]

--
Quatro alças::
+
--
image::../media/handles.gif[Alças E4000]
...
* *SG6260 compartimento de expansão*
+
Compartimento de expansão sem unidades instaladas::
+
--
...
+
--
image::../media/s25_front_with_ssds.png[Drives frontais do appliance SGF6212]
