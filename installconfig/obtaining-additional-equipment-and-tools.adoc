...
---
= Obtenha equipamentos e ferramentas adicionais para StorageGRID appliances
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.SG120 e SG1200
--
Você precisará dos seguintes equipamentos adicionais para instalar e configurar o hardware SG120 e SG1200.
...
*** QSFP de 40 GbE
*** 100-GbE QSFP28
*** QSFP56 de 200-GbE (apenas 200-GbE NIC)
...
** QSFP de 40 GbE
** 100-GbE QSFP28
** QSFP56 de 200 GbE (somente NIC de 200 GbE)
