...
---
= Reúna informações de rede para o SG6200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Antes de instalar um dispositivo SGF6212 ou SG6260, confirme se o seu sistema StorageGRID está utilizando a versão necessária do software StorageGRID.
...
SGF6212
 a| 
12.0 ou posterior (hotfix mais recente recomendado)
...
Você conecta os dois controladores de armazenamento do dispositivo SG6260 à rede de gerenciamento que será usada para SANtricity System Manager. O controlador A fica na parte superior e o controlador B na parte inferior.
...
Portas RJ-45 no dispositivo SGF6212:

image::../media/sgf6212_rj_45_ports.png[Portas RJ-45 SGF6212]

Portas RJ-45 no controlador SG6200-CN:

image::../media/sg6200_cn_rj_45_ports.png[Portas RJ-45 SG6200-CN]
...
As figuras a seguir mostram a porta de gerenciamento BMC no SGF6212 e no SG6200-CN.

_SGF6212_

image::../media/sgf6212_bmc_management_port.png[Porta de gerenciamento SGF6212]

_SG6200-CN_

image::../media/sg6200_cn_bmc_management_port.png[Porta de gerenciamento SG6200-CN]
...
Ao link:configuring-network-links.html["configurando links de rede"] para o dispositivo SGF6212, você pode usar o recurso de agregação de portas (port bonding) para as portas que se conectam à Rede Grid e à Rede Cliente opcional, bem como para as portas de gerenciamento 1/10-GbE que se conectam à Rede Administrativa opcional. A agregação de portas ajuda a proteger seus dados, fornecendo caminhos redundantes entre as redes StorageGRID e o dispositivo.
...
image::../media/sgf6212_bonded_management_ports.png[Portas de gerenciamento de rede SGF6212]

_SG6200-CN:_

image::../media/sg6200_cn_bonded_management_ports.png[Portas de gerenciamento de rede SG6200-CN]
