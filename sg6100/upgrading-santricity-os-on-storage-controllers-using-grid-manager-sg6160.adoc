...
summary: Você pode usar o Grid Manager ou o modo de manutenção para aplicar um upgrade. 
---
= Atualize o SANtricity OS nos controladores de armazenamento SG6160 usando o Grid Manager
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
