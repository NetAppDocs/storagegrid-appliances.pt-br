...
summary: 'Pode ser necessário substituir a placa de interface de rede (NIC) no SGF6112 se ela não estiver funcionando corretamente ou se tiver apresentado defeito.' 
---
= Substitua a placa de rede interna em um SGF6112 ou SG6100-CN
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
