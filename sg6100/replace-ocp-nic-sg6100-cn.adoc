...
summary: 'Pode ser necessário substituir a placa de interface de rede (NIC) no SG6100-CN se ela não estiver funcionando corretamente ou se tiver apresentado defeito.' 
---
= Substitua uma placa de rede externa em um SG6100-CN
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
