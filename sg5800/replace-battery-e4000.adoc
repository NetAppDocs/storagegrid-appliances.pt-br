...
summary:  
---
= Substitua a bateria do controlador E4000 em um SG5800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
NOTE: Pode levar 20 minutos desde o momento em que você liga os interruptores até o nó se reconectar à rede e exibir um status normal no Grid Manager.
