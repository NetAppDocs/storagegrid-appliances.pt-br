...
summary: Você pode usar o Gerenciador de Grade para aplicar uma atualização. 
---
= Atualize o sistema operacional SANtricity nos controladores de armazenamento SG5800 usando o Grid Manager
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Você pode usar o Gerenciador de Grade para aplicar uma atualização. Você também pode link:upgrading-santricity-os-on-storage-controller.html["use o modo de manutenção para aplicar uma atualização"].
