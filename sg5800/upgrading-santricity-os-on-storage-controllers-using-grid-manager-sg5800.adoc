...
---
= Atualize o SANtricity os em controladores de storage SG5800 usando o Gerenciador de Grade
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Para controladores de armazenamento que atualmente usam o SANtricity os 08.42.20.00 (11,42) ou mais recente, você pode usar o Gerenciador de Grade para aplicar uma atualização. Você também link:upgrading-santricity-os-on-storage-controller.html["use o modo de manutenção para aplicar uma atualização"]pode .
