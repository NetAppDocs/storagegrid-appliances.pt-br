...
summary:  
---
= Substitua os DIMMs no controlador E4000 em um SG5800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
** No Grid Manager, selecione *Nós* > *nó do appliance* > *SANtricity System Manager*. As informações do controlador estão no  https://docs.netapp.com/us-en/storagegrid/monitor/viewing-santricity-system-manager-tab.html["Guia Gerenciador do sistema SANtricity"].
+
