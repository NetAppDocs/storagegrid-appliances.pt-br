...
---
= Substitua as baterias CMOS em um SG120 ou SG1200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Utilize este procedimento para substituir as duas baterias tipo moeda CMOS na placa-mãe.

.Sobre esta tarefa
Para evitar interrupções de serviço, confirme se todos os outros appliances de serviço estão conectados à grid e se os grupos de alta disponibilidade foram configurados (se aplicável) antes de iniciar a substituição da bateria CMOS ou substitua as baterias durante uma janela de manutenção, quando períodos de interrupção de serviço forem aceitáveis. Consulte as informações sobre  https://docs.netapp.com/us-en/storagegrid/monitor/monitoring-system-health.html#monitor-node-connection-states["monitorização dos estados de ligação do nó"^].

.Antes de começar
* Você tem link:verify-component-to-replace.html["verifiquei o SG120 ou SG1200 onde as baterias CMOS precisam ser substituídas"].
* Você obteve as baterias CMOS de substituição corretas (CR2032).
* Você está link:locating-sg120-and-sg1200-in-data-center.html["localizou fisicamente o appliance SG120 ou SG1200"] no local onde está substituindo as baterias CMOS no data center.
