...
---
= Substitua os appliances SG120 ou SG1200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
. link:power-sg120-and-sg1200-off-on.html#shut-down-the-sg120-or-sg1200-appliance["Desligue o aparelho"].
...
.. link:reinstalling-sg120-and-sg1200-into-cabinet-or-rack.html["Remova o aparelho com falha do gabinete ou rack"].
.. Observe a posição dos componentes substituíveis (duas fontes de alimentação, sete ventoinhas de refrigeração, três NICs e dois SSDs) no dispositivo com defeito.
+
As duas unidades estão nas seguintes posições no chassi (frente do chassi com a moldura removida mostrada):

+
image::../media/sg120_sg1200_ssds_locations.png[Locais de condução]
...
CAUTION: Se desejar manter os dados nos discos, insira os SSDs nos mesmos slots que ocupavam no dispositivo com falha. Caso contrário, o Appliance Installer exibirá uma mensagem de aviso e você precisará inserir os discos nos slots corretos e reinicializar o appliance antes que ele possa se reconectar à grid.

.. link:reinstalling-sg120-and-sg1200-into-cabinet-or-rack.html["Instale o aparelho de substituição no gabinete ou rack"].
...
* link:../installconfig/troubleshooting-hardware-installation-sg120-and-sg1200.html#view-error-codes["Veja os códigos de inicialização do aparelho"]
