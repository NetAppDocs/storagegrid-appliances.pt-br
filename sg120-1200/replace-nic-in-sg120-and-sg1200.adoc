...
summary: 'Pode ser necessário substituir a placa de interface de rede (NIC) do SG120 ou SG1200 se ela não estiver funcionando corretamente ou se tiver apresentado defeito.' 
---
...
NOTE: O dispositivo SG1200 suporta portas de rede de alta velocidade e pode ter NICs de alta velocidade instaladas.
