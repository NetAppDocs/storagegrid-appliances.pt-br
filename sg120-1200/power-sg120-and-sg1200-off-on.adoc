...
---
= Desligar e ligar o SG120 ou SG1200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Você pode desligar o appliance SG120 ou SG1200 e ligá-lo novamente para realizar a manutenção.



== Desligue o appliance SG120 ou SG1200
...
== Ligue o SG120 ou SG1200 e verifique o funcionamento

Ligue o controlador após concluir a manutenção.

.Antes de começar
* Você já link:reinstalling-sg120-and-sg1200-into-cabinet-or-rack.html["instalado o controlador em um gabinete ou rack"] conectou os cabos de dados e de energia.
* Você tem link:locating-sg120-and-sg1200-in-data-center.html["localizado fisicamente o controlador no data center"].
